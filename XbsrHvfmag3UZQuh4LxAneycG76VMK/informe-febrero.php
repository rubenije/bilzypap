...
$registros   = $objInforme->getRegistrosByMes('02');
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-md-center" id="navbarNav">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="informe.php">Inicio</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="informe-enero.php">Enero</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="informe-febrero.php">Febrero</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container-fluid pt-5">
      <div class="row">
        <div class="col-12 col-md-10 m-auto pt-4">
          <a href="xls.php?mes=02" class="btn btn-success float-end">Exportar Excel</a><br>


          <h4>Registros Febrero</h4>
          <table class="table table-bordered" style="font-size: 12px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="#;" onclick="showRemoteModal('../uploads/<?= $registro->regi_directorio; ?>/<?= $registro->regi_etiqueta; ?>');" >
                   <img src="../uploads/<?= $registro->regi_directorio; ?>/<?= $registro->regi_etiqueta; ?>" class="center-cropped">
                  </a>
                </td>
