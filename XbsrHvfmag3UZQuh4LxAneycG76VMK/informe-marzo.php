...
$registros   = $objInforme->getRegistrosByMes('03');
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-md-center" id="navbarNav">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="informe-marzo.php">Marzo</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container-fluid pt-5">
      <div class="row">
        <div class="col-12 col-md-10 m-auto pt-4">
          <a href="xls.php?mes=03" class="btn btn-success float-end">Exportar Excel</a><br>


          <h4>Registros Marzo</h4>
